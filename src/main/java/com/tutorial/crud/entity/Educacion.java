...
public class Educacion implements Serializable {
    ...
    public Educacion(int id, String centro, String titulo, String tipo_estudio, String anio_ingreso, String anio_egreso) {
        this.id = id;
        this.centro = centro;
        this.titulo = titulo;
      ...
      public Educacion(String centro, String titulo, String tipo_estudio, String anio_ingreso, String anio_egreso) {
        this.centro = centro;
        this.titulo = titulo;
        this.tipo_estudio = tipo_estudio;
        this.anio_ingreso = anio_ingreso;
